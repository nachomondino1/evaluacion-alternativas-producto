...
def main():
    ...
    with tab1:
        ...
        st.image(image_1, use_column_width=True, caption="Evaluador de alternativas", width=3)
    ...
    with tab2:
        ...
        st.image(image_2, use_column_width=True, caption="Evaluador de marcas", width=3)
