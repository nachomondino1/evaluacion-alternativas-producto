...
def palabras_relacionadas(palabra):
    ...
    d_palabras_rel = {'aplicaciones': ['apps'], 'bateria': ['duracion'], 'camara': ['camaras', 'foto', 'fotos'],
                      'memoria': ['fluidez', 'almacenamiento', 'ram'],
                      'pantalla': ['resolucion', 'definicion', 'imagen'],
                      "precio": ['costo'], "procesador": ["velocidad", "funcionamiento", "software"]
                      }

    if palabra in d_palabras_rel.keys():
        # Agrego palabras adicionales a palabras a buscar
        palabras_a_buscar = [palabra] + d_palabras_rel[palabra]
