...
def main():
    ...
    producto = 'celulares'
    df_alt = pd.read_excel('/Users/nachomondino/Documents/GitHub/evaluacion-compra-automatica/data/collect_initial_data/{}/df_alt_2.xlsx'.format(producto))
    df_opi = pd.read_excel('/Users/nachomondino/Documents/GitHub/evaluacion-compra-automatica/data/collect_initial_data/{}/df_opi_2.xlsx'.format(producto))
    ...
    df_alt_cleaned.to_excel('/Users/nachomondino/Desktop/df_alt_cleaned_2.xlsx', index=False)  # cuando corra tod@ junto pongo product.nombre
    '''
    ...
    df_sent_alt = pd.read_excel('/Users/nachomondino/Documents/GitHub/evaluacion-compra-automatica/data/modelling/atribucion/{}/df_attr_alt_sent.xlsx'.format(producto))

    print(" (4.2) CLUSTERING ".center(120))
    print(" a) Creando el dataframe para clustering...")
    df_input_clustering = clustering.create_clustering_dataframe(df_alt_cleaned, df_sent_alt, df_attr_values_sent)
    ...
    clustering.create_table_cluster_centroids_sent(df_alt_cleaned_cluster)  # el cliente no la ve, es solo para mi y asi poder definir nombres de clusters
    ...
    print(" h) Obteniendo tabla de mejor marca por customer need...")
    df_relation_matrix = pd.read_excel('/Users/nachomondino/Documents/GitHub/evaluacion-compra-automatica/data/data_preparation/{}/df_relation_matrix.xlsx'.format(producto), index_col=0)
    df_best_brand_per_cust_need = clustering.create_table_best_brands_per_customer_need(df_alt_to_client, df_input_clustering, df_relation_matrix)
